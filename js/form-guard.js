...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      'background:#16162a;border:1px solid rgba(201,168,76,0.25);border-radius:16px;',
      'max-width:560px;margin:24px auto;box-shadow:0 20px 60px rgba(0,0,0,0.35);}',
      ...
      '.hsst-success-panel .hsst-success-icon{font-size:48px;margin-bottom:16px;}',
      '.hsst-success-panel h3{color:#C9A84C;font-size:20px;margin:0 0 8px;font-family:"Noto Serif TC",serif;}',
      '.hsst-success-panel p{color:rgba(255,255,255,0.72);font-size:15px;line-height:1.8;margin:0;}',
      '.hsst-success-panel p b{color:#C9A84C;font-weight:600;}',
